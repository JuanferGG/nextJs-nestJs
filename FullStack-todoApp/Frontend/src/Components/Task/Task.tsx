...
export default function TaskElement({ task }: { task: Task }) {
  ...
  return (
    <div className="flex flex-col sm:w-full lg:w-[300px] shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden cursor-pointer bg-white">
